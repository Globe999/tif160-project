...
if __name__ == "__main__":
    ...
    video_file = r"C:\Users\oskar\OneDrive\Dokument\repo\tif160-project\2024-10-21-13-47-20.mp4"
    output_dir = 'frames_output2'  # Folder to save the frames
    target_fps = 1  # Set the desired FPS (lower than the original FPS)
